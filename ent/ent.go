...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			botstate.Table:          botstate.ValidColumn,
			candidate.Table:         candidate.ValidColumn,
			candidatesnapshot.Table: candidatesnapshot.ValidColumn,
			dailyresult.Table:       dailyresult.ValidColumn,
			paperposition.Table:     paperposition.ValidColumn,
			positionevent.Table:     positionevent.ValidColumn,
			positionmark.Table:      positionmark.ValidColumn,
			socialsnapshot.Table:    socialsnapshot.ValidColumn,
			tradedecision.Table:     tradedecision.ValidColumn,
			verdict.Table:           verdict.ValidColumn,
		})
	})
